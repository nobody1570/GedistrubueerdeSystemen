...
2:start de databases (Main_C_S_Com_Controller.java) op. Zorg dat er voor elke database die men opstart een kopie van de correcte database aanwezig is. 
...
4:start het gewenste aantal applicatieservers(MainServer.java) op.

5:nu kan men een gewenst aantal clients (MainClient.java) opstarten en beginnen spelen.